...
> 原文:[https://devo PS . com/the-beauty-of-the-the-cobol-programming-language-v2/](https://devops.com/the-beauty-of-the-cobol-programming-language-v2/)

在我们结束 2018 年之际，我们 DevOps.com 想要强调今年最受欢迎的五篇文章。以下是我们为期一周的 2018 年最佳系列的第一篇。

写得好的代码是一件艺术品。过去是，将来也是。一个程序员会凭空想出一个想法，然后把它转化成一个可以被其他人使用的工作想法。它的抽象表达变成了现实。计算机编程需要深度的创造力和逻辑纪律，这在别处是很难找到的。也许建筑和理论科学很接近，但是计算机编程却与众不同。计算机编程很特别，我喜欢它！![](../Images/f110e4a4608cf9d8345bc65ca6e5e059.png)
...
![](../Images/349b4bca8ba1271955755104afc9e10c.png)
...
![beauty-of-cobol-listing-01](../Images/a2e9534f7f144142e54c523b4ce8ded2.png)
...
![beauty-of-COBOL-Listing-02](../Images/a6792b331c00eeac69758b23d1f308ef.png)

**清单 COBOL 程序 RESEL-WORLD 接受并操纵用户的输入**

用户输入和程序输出如图 2 所示。

**![](../Images/875cb9f66214e1510af4cabe09fb55d6.png)T2】**
...
**![](../Images/24ea82d376c41bc5b9348bccd271e95a.png)图 3:COBOL 文件中的每一列都被指定用于特定的目的**
...
**![](../Images/896dd47d34597ffd974017fc08f6b5d9.png)图 COBOL 程序实体的结构层次**
...
**![](../Images/05b0e6b14b476ed0b791c32f190e676a.png)** 
...
**![](../Images/57df82dfc694d78e63727cfccd0910e4.png)T2】**
...
![beauty-of-COBOL-Listing-07](../Images/4417c0d9bd96dba477521fc867cc7f6a.png)
