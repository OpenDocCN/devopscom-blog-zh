...
> 原文：<https://devops.com/threat-modeling-as-a-devsecops-practice/>
...
虽然左移运动诞生于 20 年前，其目标是确保产品测试在开发阶段的早期进行，但我认为我们需要*开始*左移，以实现真正的改变。在采用这种文化的过程中，安全性和隐私将不再是一个附加的事后想法，而是开发过程中的一个内置装置，确保工程师和安全团队保持一致，并了解彼此的目标。
