...
> 原文：<https://devops.com/vmware-embraces-smartnics-to-extend-virtualization/>
...
vRealize Network Insight 6.0 的 6.0 版将增加保证和验证功能，并扩展对 VMware SD-wan 的支持。与此同时，VMware Edge Network Intelligence 增加了一个应用人工智能(AI)来优化网络性能的工具。 ****
