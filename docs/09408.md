...
> 原文:[https://devo PS . com/pull-based-kubernetes-deployments-moving-to-git lab-free-tier/](https://devops.com/pull-based-kubernetes-deployments-moving-to-gitlab-free-tier/)
