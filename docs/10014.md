...
> 原文：<https://devops.com/migration-to-aws-cloud-dos-and-donts/>
...
![](img/b3ae1b8449323ed55a78ef754c2d3467.png)
...
迁移得太快。企业可能会想，“我们必须快速迁移到云。让我们现在就做托举和移位！”最好不要马上开始。你确定主机更换策略真的比其他策略更快吗？在一个例子中，我们尝试迁移本地虚拟机，但没有成功，因为机器上的操作系统非常旧。一些操作系统级的依赖在 AWS 的硬件上不起作用。这需要大量的配置工作、定制代码和测试，而最初的估计完全错误。它最终被证明是一个平台。
