...
> 原文：<https://devops.com/pingcaps-innovative-tidb-database-techstrong-tv/>
...
刘:基本上，我们有一个复制算法。它叫做木筏。所以，我们使用 raft 来复制数据，并将它们存储为行存储和列存储，所以，您有两个副本，对吗？那么，你可以设计一个优化器来选择哪种数据，我应该使用哪一部分，对吗？
