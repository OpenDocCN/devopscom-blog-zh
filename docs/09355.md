...
> 原文:[https://devo PS . com/sys dig-introduces-sys dig-advisor-to-classically-simplify-kubernetes-trouble shooting/](https://devops.com/sysdig-introduces-sysdig-advisor-to-drastically-simplify-kubernetes-troubleshooting/)
