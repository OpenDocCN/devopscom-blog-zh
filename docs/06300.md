...
> 原文：<https://devops.com/unravel-data-expands-support-for-modern-data-workloads-in-the-cloud-with-introduction-of-unravel-for-aws-databricks/>
...
> 
>  **Application performance management for AWS data blocks [ -unfraul provides services for Spark applications, clusters, Visibility and understanding of workflow and underlying software stack**
> 
>  **Automated root cause analysis of Spark applications [ -unlaunch can automatically identify, diagnose and repair Spark jobs and the entire Spark stack, Thereby solving the problem of Spark application on AWS Databricks cluster more simply and quickly**
> 
