...
> 原文：<https://devops.com/dataops-and-beyond-how-devops-methodology-transformed-our-approach-to-data-science/>
...
*   **自动化和连续性:在一个组织内，业务数据通过一个设定的流程移动，类似于 DevOps 类比的软件生命周期，数据以一种形式接收，以另一种形式退出。工程师必须建立数据管道，在部署之前对其进行测试和更改。通过采用上面概述的自动化标准和最佳实践，您将理想地拥有流经管道的恒定数据流。这释放了从数据中获取实时洞察力的潜力，缩短了将原始数据转化为有价值的业务信息所需的时间。**
*   **文化转变:当正确完成时，DataOps 改变了组织内谁成为数据用户。更高的透明度和质量保证意味着非技术团队中的决策者可以更公开地获得数据。考虑一下销售团队的业务增值，他们希望扩展到新的市场，并且能够访问大量的客户数据。**
