...
> 原文:[https://devo PS . com/integrating-maven-and-nexus-for-continuous-delivery-with-Jenkins/](https://devops.com/integrating-maven-and-nexus-for-continuous-delivery-with-jenkins/)
...
![](../Images/74455ea601b5aa68e14f8d4154c90f66.png)

## **托管存储库**

托管存储库是在存储库管理器中存储组件的存储库，作为这些组件的权威位置。

![](../Images/9188a1e7cb9f05c26dbd1eaf1f2be508.png)

对于发布，除了名称、版本策略和部署策略之外，请遵循与快照相同的配置。

![](../Images/b98f073f85e52f306fddf9b58ab897c0.png)

![](../Images/0e8de0750bd819b37ad64352b9ec9e70.png)

![](../Images/049255be8a3baacdf2ff4d2694b4fc21.png)
...
**![](../Images/c7dc7daf2f0d4ff7ff7db7f37f3e1d0b.png)T2】**
...
<settings xmlns="”http://maven.apache.org/SETTINGS/1.1.0″&nbsp;" xmlns:xsi="”http://www.w3.org/2001/XMLSchema-instance”&nbsp;" xsi:schemalocation="”http://maven.apache.org/SETTINGS/1.1.0" href="https://maven.apache.org/xsd/settings-1.1.0.xsd">http://maven.apache.org/xsd/settings-1.1.0.xsd></settings>
...
<url>http://主机名:8081/repository/maven-snapshot s/</url>
...
<connection>单片机:转到:http://gitlab.com/user/project .转到</connection>

<url>[【http://gitlab.com/user/project】](https://github.com/user/project)</网址></url>

<developerconnection>单片机:转到:http://gitlab.com/user/project .转到</developerconnection>
...
**![](../Images/9dfdc71836bdefcfd417e373ec89e560.png)T2】**

快照构建完成后，需要以下输入来执行 Maven 发布。这里，用户名和密码指的是 GitLab 管理员凭据。

![](../Images/4cd87279c614ab2a35fad411532dcb41.png)
