...
> 原文:[https://devo PS . com/IBM-boosts-security-and-productivity-with-red-hat-open shift-4-3-on-IBM-cloud/](https://devops.com/ibm-boosts-security-and-productivity-with-red-hat-openshift-4-3-on-ibm-cloud/)
...
今天就开始:
如果您有任何问题或意见，请通过 Slack 联系我们的团队。可以 [在这里](https://cloud.ibm.com/kubernetes/slack) 注册，在[https://IBM-cloud-success 上的#openshift 频道加入讨论。<wbr>slack.comT9】。
