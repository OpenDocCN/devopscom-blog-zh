...
> 原文:[https://devo PS . com/platform 9s-managed-kubernetes-solution-adds-arbitrage-capabilities-to-dynamic-run-nodes-in-a-cluster-on-Amazon-ec2-spot-instances/](https://devops.com/platform9s-managed-kubernetes-solution-adds-arbitrage-capabilities-to-dynamically-run-nodes-in-a-cluster-on-amazon-ec2-spot-instances/)
