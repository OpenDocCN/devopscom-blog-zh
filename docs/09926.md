...
> 原文:[https://devops.com/introduction-to-spiffe-spire/](https://devops.com/introduction-to-spiffe-spire/)
...
[![](../Images/9f649577001c697a81dc90e5dd5fc6ca.png)](https://containerjournal.com/wp-content/uploads/2022/10/spiffe-logo.png) 面向所有人的安全生产身份框架( [SPIFFE](https://spiffe.io/) )是工作负载身份的规范。根据吉尔曼的说法，最简单的方法就是把斯皮夫当成护照。类似于如何向人们发放带有条形码和标准信息的通用形状的护照，SPIFFE 规定了证明和验证服务身份的标准方法。他补充道，这就像把“登录谷歌”的体验带到了软件服务本身。
