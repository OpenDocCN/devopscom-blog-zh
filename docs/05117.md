# Fugue 宣布免费层，使工程师能够构建和操作安全的云系统

> 原文:[https://devo PS . com/fugue-announces-free-tier-to-empower-engineers-to-build-and-operate-secure-cloud-systems/](https://devops.com/fugue-announces-free-tier-to-empower-engineers-to-build-and-operate-secure-cloud-systems/)
