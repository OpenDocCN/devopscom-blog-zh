...
> 原文：<https://devops.com/cracking-production-performance-issues-with-open-source-observability/>
...
![](img/ad1af5b39e06a18d0150b6ad7a9fc1f8.png)

除了每个可疑请求的处理时间之外，我们还看到对处理用户会话令牌的微服务的请求数量的增长。同样，我们注意到在同样的高峰时段有非常高的请求负载。

![](img/967ae9f9c3a4c80c9303f10287a1036e.png)
...
![](img/b34300d5d91471718dd3c5a77c79cd71.png)

此外，在同一时期，我们的数据库集群面临着巨大的复制延迟:

![](img/2706509bce291e794ae9f9c4544ccdd1.png) ![](img/ad88afc5b62f3ab54d98c4d3404ba116.png)

### **分布式跟踪**

最后但同样重要的是，我们的追踪产品建立在开源的 Jaeger 之上。我们通过过滤掉耗时不到 5 秒的请求来检查高延迟模式。同样，在高峰时段，慢速请求会更多地出现。

![](img/f409726afac04bfd10cdedc84a43b5d9.png)
...
![](img/0d9e8eef8e92a37858a893604cf55354.png)
...
![](img/b2fd192b3f6b97d522aa1681b34c3742.png)需要强调的是，在非高峰时段，这些微服务最多需要 10 毫秒:

![](img/de7e737a7fb759a18d0a5171149d3ec9.png)
...
![](img/1cda1b51bd90a375bdc9956c0ccadbef.png)

我们可以看到事务提交的总大小在部署后立即下降。

此外，我们看到对有问题的服务的请求总数减少了 80%以上！
![](img/7fafa834fe59d4543a24fe0cab5c1fbc.png)

最重要的是，我们一部署修复程序，所有受影响的终端的延迟都下降了:

![](img/485da9caf501bd42146d9ae0f9c6eb3a.png)
