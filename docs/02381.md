# Cloudbees AWS 快速启动解决方案削减了持续交付部署时间和云计算成本

> 原文:[https://devo PS . com/cloud bees-AWS-quick-start-solution-slashes-continuous-delivery-deployment-time-and-cloud-computing-costs/](https://devops.com/cloudbees-aws-quick-start-solution-slashes-continuous-delivery-deployment-time-and-cloud-computing-costs/)
