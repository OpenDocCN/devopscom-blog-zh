...
> 原文：<https://devops.com/securing-the-software-supply-chain-with-behavioral-analysis/>

最近，软件[供应链](https://devops.com/?s=supply+chain)发现自己处于一个非常有趣和不舒服的位置——行业焦点——而且不是以一种好的方式。虽然重大且代价高昂的违规(如  [【网络安全管理软件产品】](https://blog.reversinglabs.com/blog/sunburst-the-next-level-of-stealth) 或 [Kaseya](https://securityboulevard.com/?s=Kaseya) )会成为头条新闻，但供应链攻击战术(如域名仿冒或依赖性混淆)会使目标包管理器(如[【NPM】](https://blog.reversinglabs.com/blog/groundhog-day-npm-package-caught-stealing-browser-passwords)、PyPI 或 [WinGet](https://www.bleepingcomputer.com/news/security/windows-10s-package-manager-flooded-with-duplicate-malformed-apps/) )毒害下游应用程序或危及开发者凭证。
...
![supply chain](img/a5e8c837214c761298fabf3d7509a602.png)
