...
> 原文：<https://devops.com/cloudbees-advances-expanding-devops-agenda/>
...
![](img/9ba6373117108f50cd3253a9bb8e2231.png)与此同时，DevSecOps 产品为 IT 团队提供了一个强化的 CloudBees CI 产品实例，以及强化的审计就绪管道，以确保只使用不可变的、经批准的组件和环境，而没有任何偏差或篡改。CloudBees 还增加了对基于角色的访问控制的支持，这种访问控制基于细粒度的权限以及与 CI/CD 平台的功能标记功能的更紧密集成。如果在生产环境中出现问题，可以通过自动提供的完全可追溯性撤回特定的特性。
