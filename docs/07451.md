...
> 原文：<https://devops.com/protecting-data-from-insider-threats/>
...
![insider threats](img/88c4f488048b6678c2b3dbea48c14c2c.png)
例 1

使用像 Sentinel 这样的框架，对生产环境的更改可以仅限于随叫随到的工程师。(参见下面的示例 2。)

![insider threats](img/05040a086d9378470263932c88ea06c9.png)

示例 2

类似的策略可以只限制那些能够通过从保险库中获取密钥来读取 S3 桶的未加密内容的工程师。(参见下面的实施例 3。)

![insider threats](img/430cbfc8e9b4ab936b2646b3d086cfb8.png)
