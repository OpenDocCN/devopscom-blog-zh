...
> 原文：<https://devops.com/puppet-best-practices/>
...
**登台**和**生产**是两个傀儡环境，登台环境用于向所有预生产机器初始配置服务器，生产服务器利用生产环境。两个环境都绑定到 Git 存储库中的特定分支，即 Git 中的 ***【主】*** 分支是 ***【生产】******【暂存】*** 分支是 ***暂存。***
