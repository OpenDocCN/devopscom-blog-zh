...
> 原文:[https://devops.com/vmware-backup-guide-for-hyper-v-admins/](https://devops.com/vmware-backup-guide-for-hyper-v-admins/)
...
![](../Images/2d6c6f420a2a4643fb257ecc4b6e97e5.png)T2】
...
![](../Images/1f1dad4542f96376a086f00cbf594f90.png)T2】

选择要转换的虚拟机。点击**下一个**。

![](../Images/2f4ab92685d8cc435dbb977495f7e687.png)T2】

选择 **VMware 基础架构虚拟机**作为目标类型。键入 vCenter Server 或 ESXi 主机的 IP 地址，然后输入用户名和密码。点击**下一个**。

![](../Images/9f40cdea43d2988ce678f940d1f703fd.png)T2】

选择转换后应应用于目标虚拟机的文件夹和名称。点击**下一个**。

![](../Images/490146162f4dd254a1ed4e6c926873fe.png)T2】

选择目标位置，包括 ESXi 主机和数据存储区。点击**下一个**。

![](../Images/45358da44d61d5336d40a3a087bdb166.png)T2】

为目标虚拟机配置选项。您可以在下面提供的屏幕截图中看到如何更改虚拟磁盘资源调配的类型。在**数据复制**区点击**编辑**。

![](../Images/4a0399e7a28b5a85961cf2f17fd53935.png)T2】

在下拉列表中，选择磁盘资源调配类型(密集或精简)。点击**下一个**。

![](../Images/c035e2cf4522e5a27367dfba5905ee5b.png)T2】

检查摘要，如果满意，点击**完成**。

![](../Images/246f1784256ef5a4d4e5743303689fa5.png)T2】

等待转换任务完成。

![](../Images/4f0511c6d40aa5c3bc696ba8dcaa4755.png)T2】
...
![](../Images/54efa09f1521ccf7f4e561cc45809c23.png)T2】
