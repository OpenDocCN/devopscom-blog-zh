...
> 原文:[https://devops.com/aws-reinvent-top-4-richixbw/](https://devops.com/aws-reinvent-top-4-richixbw/)

欢迎来到[![](../Images/209b5cd0a4d4da216206f2a69faa2a5e.png)](https://devops.com/tag/the-long-view/)*——在这里我们细读本周新闻，并将其剥离至要点。让我们弄清楚**什么是真正重要的**。*
...
<big>**`Cached snapshots`**</big>T5】AWS 宣布了对… Lambda 的更新，增加了 SnapStart 特性，减少了 Java 函数的冷启动。据该公司称，有时启动该功能的运行时间需要长达 10 秒钟。
…
...
<big>**`We’re gonna keep building`**</big>
