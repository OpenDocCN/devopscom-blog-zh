...
> 原文：<https://devops.com/threat-modeling-the-why-how-when-and-which-tools/>
...
![](img/3e7711312f8caf437412dd0704060df0.png) **步骤 1:** 识别资产(数据库服务器、文件服务器、数据湖存储、活动目录、REST 调用、配置屏幕、Azure 门户、认证和匿名 web 用户、Azure AAD 客户端应用、数据库用户、数据库管理员)
