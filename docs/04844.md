...
> 原文：<https://devops.com/ten-years-later-what-is-cloud-native/>
...
![](img/114015c418fa46e264f7b9b5a73112c4.png)

*   **应用:应用是为特定用例设计和实现的一组组件。**

*   **平台:平台是一组独立于特定用例而设计和实现的组件。**

*   **系统:系统是应用和平台的结合。一般来说，我们称应用程序托管在一个平台上。**
...
*   **公共云平台:公共云平台是在自己的组织之外提供资源的服务提供商。**

*   **私有云平台:私有云平台是在自己的组织内提供资源的服务提供商。**
...
![](img/d84401340f1f0596d54ea1645a977c0b.png)
...
*   **SLO 延迟:在这个例子中，我们定义如果一个事务的 SLI 延迟小于 250 毫秒，就要满足的 SLO 延迟。**
